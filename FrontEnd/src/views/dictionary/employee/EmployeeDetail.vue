<template>
    <div class="m-dialog center-div " @keydown.ctrl.shift.83.exact.prevent.stop="storeInformation(true)"
        @keydown.ctrl.83.exact.prevent.stop="storeInformation(false)" @keydown.esc.exact.prevent.stop="displayWarning">
                    ...
                    <div class="show-flex">
                        <div class="input-information w1p4 ">
                            ...
                            <BaseInput tabindex="16" ref="PhoneNumber" classList="user-input  " type="text" refType=""
                                validType="none" name="PhoneNumber" maxlength="20"
                        ...
                        <div class="input-information w1p4 ">
                            ...
                            <BaseInput tabindex="17" ref="TelephoneNumber" classList="user-input  " type="text"
                                refType="" validType="none" name="TelephoneNumber" maxlength="20"
                        ...
                        <div class="input-information w1p4 mr0">
                            ...
                            <BaseInput tabindex="18" ref="Email" classList="user-input  " type="text" refType=""
                                validType="none" name="Email" maxlength="100"
                    ...
                    <div class="show-flex">
                        <div class="input-information w1p4 ">
                            ...
                            <BaseInput tabindex="19" ref="BankAccountNumber" classList="user-input" type="text"
                                name="BankAccountNumber" maxlength="20"
                    ...
                    <div class="footer">
                        <div class="footer-left">
                            <BaseButton tabindex="22" @click="$emit('hideForm')" bgColor="#fff" classList="cancel"
                                :btnText="footerFormButtonContent['cancel']"
                        ...
                        <div class="footer-right">
                            <BaseButton tabindex="23" @click="storeInformation(false)" class="px-3" bgColor="#fff"
                                :btnText="footerFormButtonContent['save']"
                            ...
                            <BaseButton tabindex="24" @click="storeInformation(true)" id="btn-employee-save"
                                bgColor="rgb(44, 160, 28)" textColor="#ffffff" bgHoverColor="#35bf22"
                                :btnText="footerFormButtonContent['saveAndMore']"
                                :tooltipContent="tooltipContent['footerFormButton']['saveAndMore']" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            async checkValidity() {
                ...
                let convertTextEmployee = this.resource[this.$browserLocale]['management']['entity']['Employee'][
                    'dictionaryError'
                ];
                // Loop qua các refs của input và combobox
                for (const [key] of Object.entries(this.$refs)) {
                    if (this.$refs[key].inputContent == null && this.$refs[key].date == null)
                        continue;
                                ...
                                if (res.data.length == 0)
                                    ...
                                    if (res.data.EmployeeId == this.currentEmployee.EmployeeId)
                                        ...
                                        this.$refs[key].errorContentData = convertTextEmployee[key]['duplicate']
                                            .format(value);
                                        console.log(this.$refs[key].errorContentData,content);
                                    }
                                }
                            } catch (error) {
                                let objectPopUp = {};
            ...
            focusErrorField(errorContents) {
                ...
                for (let i = 0; i < errorContents.length; i++) {
                    ...
                    if (dateInput.includes(errorContents[i].key)) {
                        ...
                        this.$refs[errorContents[i].key].$refs.inputCombobox.isChange = true; // trạng thái thay đổi dữ liệu = true
                    } else {
                        // Input Component
                        if (firstTime) {
