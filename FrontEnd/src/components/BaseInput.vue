<template>
    <div class="input-container" :class="classInputContainer">
        ...
        <input :tabindex="tabindex" :maxlength="maxlength" @mouseover="isDisplayToolTip = true" ref="input"
            ...
            @keydown="evtKeyboardChoosingOption" @input="inputChange" @change="validateContent"
    ...
    export default {
        ...
        methods: {
            ...
            evtKeyboardChoosingOption(e) {
                if ((this.validType == 'combobox-required' || this.validType == 'combobox') && [38, 40, 13].includes(e.keyCode))
