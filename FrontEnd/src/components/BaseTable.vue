    ...
    <table :class="type">
        ...
        <thead>
            <tr>
                ...
                <th style=" width: 40px; min-width: 40px; max-width: 40px; position: sticky; left:20px; z-index:3;"
                    class="main-th">
                    <div class="count">
                ...
                <th class="main-th" v-for="(th,index) in ths"
                    ...
                    <i class="fas fa-sort icon-input"
                        style="color: #bbbbbb; position:absolute; top: 50%; transform: translateY(-50%); right: 15px; cursor: pointer;"
        ...
        <tbody>
            <tr @dblclick="dbClickRow(data,$event)" :class="{'bg-selected': checkedList[index]}"
                ...
                <td style="width: 40px; min-width: 40px; max-width: 40px;position: sticky; left:20px; z-index:2; background-color: #fff;"
    ...
    export default {
        ...
        mounted() {
            ...
            window.addEventListener('click', (event) => {
                let dropdown = document.querySelectorAll('.function .function-dropdown .dropdown');
                if (dropdown != null && Array.from(dropdown).filter(e => e == event.target).length == 0) {
