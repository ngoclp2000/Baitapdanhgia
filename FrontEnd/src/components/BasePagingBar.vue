<template>
    <div class="paging-bar">
        <div class="display-number paging-left">{{textResource['total']}}: <span class="bold-text">{{totalRecord}}</span> {{textResource['record']}}
        </div>
        ...
        <div class="paging-right">
            <BaseCombobox v-click-outside="hideBorderCombobox" @click.native="showBorderCombobox" ref="pageSize"
                ...
                @updateContent="updatePageSize" isDisabledInput="1"
            ...
            <div class="paging paging-center">
                <BaseButton :isReadyData="isReady" @click="goToPreviousPage" class="large"
                    :classList="'btn-text large ' + (currentPage == 1 ? 'disable' : '')" :disable="currentPage==1"
                ...
                <BaseButton :isReadyData="isReady" @click="goToNextPage" class="large" :btnText="pagingBarButtonContent['next']" alt=""
                    :classList="'btn-text large ' + (currentPage == maxPageNumber ? 'disable' : '')"
    ...
    export default {
        ...
        computed: {
            ...
            pagingBarButtonContent() {
                return this.$store.state.resource[this.$browserLocale]['management']['entity']['Employee']['buttons']['content']['pagingBarButton'];
            },
        }
    }
</script>
...
<style scoped>
    ...
    @font-face {
        font-family: 'Notosans-Bold';
        src: url('../static/font/notosans-bold.woff2') format('opentype');
    }
</style>